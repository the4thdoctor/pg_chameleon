...
class pg_engine(object):
	...
	def upgrade_catalogue_v2(self):
		"""
			The method upgrade a replica catalogue  from version 2.0  to version 2.1
	...
	def rollback_upgrade_v2(self):
		"""
			The procedure rollsback the upgrade dropping the schema sch_chameleon and renaming the saved version 2.0 to sch_chameleon
			:todo: write the procedure
		"""
